...
interface ButtonProps {
  ...
  variant?: "primary" | "secondary" | "danger" | "info" | "dark" | "light" | "outline"; // Button variant
...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    dark:
      "bg-gray-900 text-white shadow-theme-xs hover:bg-black disabled:bg-gray-700",

    light:
      "bg-gray-100 text-gray-800 shadow-theme-xs hover:bg-gray-200 disabled:bg-gray-100 disabled:text-gray-400",
